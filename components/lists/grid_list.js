...
export default function Example({ data, other }) {
        ...
        <li key={el.name} className="col-span-1 bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="w-full flex justify-between p-6 space-x-6">
            <div className="flex-1 truncate">
              ...
              <div className="flex items-center space-x-3">
                <h3 className="text-gray-900 text-lg font-medium truncate">{el.name}</h3>
              </div>
          ...
          <div>
            <div className="-mt-px flex">
              ...
              <p className=" mt-1 text-gray-500 text-sm truncate">{"by Auction House"}</p>
              <p className=" mt-1 text-gray-500 text-sm truncate">{"ending in 4 days"}</p>
              <Link href={`auction/${el.id}`}>
                <a
